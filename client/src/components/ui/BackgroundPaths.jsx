...
function FloatingPaths({ position }) {
  const paths = Array.from({ length: 36 }, (_, i) => ({
    ...
    d: "M-" + (380 - i * 5 * position) + " -" + (189 + i * 6) + "C-" +
      (380 - i * 5 * position) + " -" + (189 + i * 6) + " -" + (312 - i * 5 * position) + " " + (216 - i * 6) + " " +
      (152 - i * 5 * position) + " " + (343 - i * 6) + "C" + (616 - i * 5 * position) + " " + (470 - i * 6) + " " +
...
export function BackgroundPaths({ title, subtitle, children }) {
